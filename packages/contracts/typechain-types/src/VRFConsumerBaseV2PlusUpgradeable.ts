...
export interface VRFConsumerBaseV2PlusUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "owner"
...
export interface VRFConsumerBaseV2PlusUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): VRFConsumerBaseV2PlusUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: VRFConsumerBaseV2PlusUpgradeableInterface;
